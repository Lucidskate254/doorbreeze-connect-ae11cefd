...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        className={cn(buttonVariants({ variant, size, className }), "after:content-[''] after:absolute after:w-full after:h-[2px] after:bottom-0 after:left-[-100%] after:transition-[left] after:duration-300 after:ease-in hover:after:left-0")}
        ref={ref}
        {...props}
      />
    )
